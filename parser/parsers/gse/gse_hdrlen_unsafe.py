...
class GseHdrlenUnsafe(KaitaiStruct):
    ...
    def _read(self):
        self.start_and_end_indicators = KaitaiStream.resolve_enum(GseHdrlenUnsafe.Se, self._io.read_bits_int_be(2))
        ...
        if not (self.is_padding):
            ...
            if _on == GseHdrlenUnsafe.Se.end:
                self._raw_payload = self._io.read_bytes((self.gse_length - 2))
                _io__raw_payload = KaitaiStream(BytesIO(self._raw_payload))
                self.payload = end_of_pdu.EndOfPdu(_io__raw_payload)
            elif _on == GseHdrlenUnsafe.Se.start:
                self._raw_payload = self._io.read_bytes((self.gse_length - 2))
                _io__raw_payload = KaitaiStream(BytesIO(self._raw_payload))
                self.payload = start_of_pdu.StartOfPdu(2, _io__raw_payload)
            elif _on == GseHdrlenUnsafe.Se.whole:
                self._raw_payload = self._io.read_bytes((self.gse_length - 2))
                _io__raw_payload = KaitaiStream(BytesIO(self._raw_payload))
                self.payload = whole_pdu.WholePdu(2, _io__raw_payload)
            elif _on == GseHdrlenUnsafe.Se.middle:
                self._raw_payload = self._io.read_bytes((self.gse_length - 2))
                _io__raw_payload = KaitaiStream(BytesIO(self._raw_payload))
    ...
    def is_whole(self):
        ...
        self._m_is_whole = self.start_and_end_indicators == GseHdrlenUnsafe.Se.whole
    ...
    def is_middle(self):
        ...
        self._m_is_middle = self.start_and_end_indicators == GseHdrlenUnsafe.Se.middle
    ...
    def is_padding(self):
        ...
        self._m_is_padding =  ((self.start_and_end_indicators == GseHdrlenUnsafe.Se.middle) and (self.label_type_indicator == 0) and (self.gse_length == 0)) 
    ...
    def is_end(self):
        ...
        self._m_is_end = self.start_and_end_indicators == GseHdrlenUnsafe.Se.end
    ...
    def is_start(self):
        ...
        self._m_is_start = self.start_and_end_indicators == GseHdrlenUnsafe.Se.start
