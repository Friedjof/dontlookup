...
class GseStandard(KaitaiStruct):
    ...
    def _read(self):
        self.start_and_end_indicators = KaitaiStream.resolve_enum(GseStandard.Se, self._io.read_bits_int_be(2))
    ...
    def is_whole(self):
        ...
        self._m_is_whole = self.start_and_end_indicators == GseStandard.Se.whole
    ...
    def is_middle(self):
        ...
        self._m_is_middle = self.start_and_end_indicators == GseStandard.Se.middle
    ...
    def is_padding(self):
        ...
        self._m_is_padding =  ((self.start_and_end_indicators == GseStandard.Se.middle) and (self.label_type_indicator == 0) and (self.gse_length == 0)) 
    ...
    def is_end(self):
        ...
        self._m_is_end = self.start_and_end_indicators == GseStandard.Se.end
    ...
    def is_start(self):
        ...
        self._m_is_start = self.start_and_end_indicators == GseStandard.Se.start
