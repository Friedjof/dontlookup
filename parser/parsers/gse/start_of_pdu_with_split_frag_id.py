...
import handle_pdu_protocol
class StartOfPduWithSplitFragId(KaitaiStruct):
    ...
    def _read(self):
        self.frag_id = self._io.read_bits_int_be(6)
        self.counter = self._io.read_bits_int_be(2)
        ...
        self.data_field = handle_pdu_protocol.HandlePduProtocol(self.protocol_type, self._io)
